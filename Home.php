...
<html lang="en">
    ...
    <body>
        ...
        <nav class="codrops-demos">
          ...
          <a class="current-demo" href="Home.php"> Home  </a>
          ...
          <a href="Out.php">  Log Out   </a>
            ...
            <header>
                ...
                <h1><strong>ADD RECORDS</strong></h1>
...
<br>
                             ...
                             <br>
                          <p><button class="btn-update" name="add" value="add"><h4>Add Data</h4></button></p>
                      </form></center>
  ...
  <h2>User Data</h2><table>
    <h3> &nbsp <span> &nbsp </span></h3>
                          <tr>
                            ...
                            <th>Total Sales per Day   &nbsp &nbsp &nbsp &nbsp  &nbsp     </th></h2>
                          </tr>
                          <?php 
